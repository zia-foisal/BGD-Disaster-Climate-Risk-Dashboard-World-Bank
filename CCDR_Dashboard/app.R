                       ...
                       tabPanel("main_page1", 
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default", fixed= TRUE,
                                              ...
                                              selectInput("indicator_map",
                                                          ...
                                                          # hazards_options,
                                                          selectize = F),
                                              conditionalPanel(condition = "input.domain_map == 'Natural Hazards' ||
                                              ...
                                              conditionalPanel(
                                                condition = "input.indicator_map !== 'Expected annual mortality due to coastal floods (population count)'&&
           ...
           sidebarLayout(
             sidebarPanel(
               ...
               selectInput("indicator_map1",
                           ...
                           selectize = F),
               conditionalPanel(condition = "input.domain_map1 == 'Natural Hazards' ||
               ...
               selectInput("indicator_map2",
                           ...
                           choices = hazards_options,
                           selectize = F),
               conditionalPanel(condition = "input.domain_map2 == 'Natural Hazards' ||
  ...
  tabPanel("GRAPHS",
           sidebarLayout(
             ...
             selectInput(
               ...
               selectize = F),
             conditionalPanel(
             condition = "input.domain_bar == 'Natural Hazards' ||input.domain_bar == 'Relative Wealth Index'",
           ...
           tabsetPanel(
             tabPanel("ABOUT",
                      mainPanel(
                        ...
                        "The long-term Climate Risk Index (CRI) ranks Bangladesh as the 7th most at-risk country over the 2000-2019 period,
                        with 173 extreme events recorded (CRI 2021). Global climate projections of temperature and precipitation,
                        compounded by the degradation of the environment, due to land use patterns and unplanned urban development,
                        indicate that", tags$b("even under the most optimistic global climate scenario,
                                               Bangladesh will continue to disproportionally – and more frequently and intensely – suffer "), 
                        "from extreme weather events and long-term climatic changes."  ) , 
                        
                        tags$p(tags$b("However, Disaster and climate Risk are not uniform across space."),
                        "It is a function of the probability and intensity with which a hazard occurs,
                        and the exposure of people and assets to this hazard, both of which differ strongly across geographies.
                        Moreover, socioeconomic conditions, driving vulnerability, are also highly heterogenous at small scales, 
                        making communities and households more, or less, vulnerable in the face of climate change. The analytics in this dashboard",
                        tags$b("zoom in to the level of granular administrative units,
                               where investment decisions are made and local policy should be targeted.")),
                               
                               tags$p(tags$b("This dashboard focuses on disaster risk from floods, heat stress, droughts, landslides, tropical cyclone,
                               and air pollution."), "These pose a critical environmental concern for Bangladesh,
                               and indeed across large parts of South Asia. To assess and quantify the impact of these hazards, 
                               whether extreme events or long-term climatic changes, we look at", 
                               tags$b("three types of exposure: (1) population, (2) built-up assets, and (3) agricultural land."),
                               "Where available, an impact function is added to the exposure variables,
                               to demonstrate the expected annual impact on population health in terms of morbidity and mortality,
                               the potential damage to built-up assets and to agricultural land.
                               Vulnerability is then captured by a series of", 
